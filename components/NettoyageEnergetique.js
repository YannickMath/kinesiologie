...
export default function NettoyageEnergetique() {
  ...
  return (
    <div className="relative min-h-screen lg:flex ">
      ...
      <div className=" mt-40 lg:mt-40 sm:mt-16  flex flex-col justify-center text-[#050202] lg:h-full h-full font-roboto space-y-4 lg:space-y-6  lg:text-base p-5 lg:p-0">
        <p className=" lg:mr-10 lg:ml-10 sm:mt-10 md:mt-20 mt-6 ">{nettoyage.item1}</p>
