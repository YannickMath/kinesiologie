...
export default function AproposDeMoi({isSmallScreen}) {
  ...
  return (
    <div className=" min-h-screen relative flex flex-col md:flex-row font-roboto">
      <div className="bg-gray-100 font-bold justify-center mt-40 md:mt-0  space-y-2 md:space-y-4 lg:space-y-6  p-4 w-full md:w-4/5 h-full md:h-auto">
